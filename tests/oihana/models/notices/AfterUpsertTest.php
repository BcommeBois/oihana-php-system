...
class AfterUpsertTest extends TestCase
{
    public function testCanBeInstantiatedWithoutArguments(): void
    {
        $notice = new AfterUpsert();

        $this->assertSame(NoticeType::AFTER_UPSERT, $notice->type);
    ...
    public function testCanBeInstantiatedWithArguments(): void
    {
        ...
        $notice = new AfterUpsert($data, $target, $context);
    ...
    {
        $notice = new AfterUpsert('some data', new stdClass());
