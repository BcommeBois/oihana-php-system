...
Thanks for helping improve **oihana/php-system**.

## Requirements

- **PHP 8.4+**
- **Composer**
- The `fileinfo`, `imagick`, `pdo` and `zip` PHP extensions.
- **Xdebug** or **PCOV** — only needed to measure test coverage (see below).

## Setup

```shell
git clone https://github.com/BcommeBois/oihana-php-system.git
cd oihana-php-system
composer install
```
